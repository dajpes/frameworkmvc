<x-app-layout>
    ...
    <div class="flex mx-10 mt-4 space-x-5">
        ...
        <div class="p-10 border rounded shadow-xl">
            <x-heroicon-o-annotation class="w-10 h-10 mx-auto text-green-500" />
            <h2 class="mt-6 text-xl font-bold">Publicaciones</h2>
            <div class="mt-5">
                <a href="{{url('/post/index')}}"class="p-2 font-bold text-white bg-green-400 rounded">Ver</a>
            </div>
        </div>
    </div>
</x-app-layout>
